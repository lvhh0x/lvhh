// 회사 시뮬레이션 타입 타일 (Server Component)
// 주식 SimTile.tsx와 동일 패턴 — company 타입 참조 별도 복제.
// active: 금색 hover 테두리 + next/link 이동 + 우상단 OPEN
// coming-soon: dim + 클릭 불가(div) + 우상단 "준비 중" 뱃지
import Link from 'next/link';
import type { CompanyTileData } from '@/lib/company/tiles';

interface Props {
  tile: CompanyTileData;
}

export default function CompanyTile({ tile }: Props) {
